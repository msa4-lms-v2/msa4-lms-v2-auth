...
public class ApiResponseCustomizer implements OperationCustomizer {
    ...
    public Operation customize(Operation operation, HandlerMethod handlerMethod) {
        com.msa4lmsv2auth.global.config.openapi.CustomApiResponse annotation = handlerMethod.getMethodAnnotation(com.msa4lmsv2auth.global.config.openapi.CustomApiResponse.class);
        if (annotation == null) {
            return operation;
        }
