package com.msa4lmsv2auth.global.response.constant;
...
class CustomResponseCodeTest {
    ...
    void responseUsesClientMessageInsteadOfEnumName() {
        GlobalResponseDTO<Void> response = GlobalResponseDTO.from(CustomResponseCode.INVALID_TOKEN_ERROR);

        assertThat(response.code()).isEqualTo("E04");
